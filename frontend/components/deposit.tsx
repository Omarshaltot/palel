...
export default function Deposit({ user, onBack, updateBalance }: DepositProps) {
  ...
  return (
    <Card className="p-6">
      <h2 className="text-2xl font-bold text-gray-800 mb-6">Deposit</h2>
      ...
      <div className="flex gap-3">
        <Button onClick={handleDeposit} className="flex-1 bg-purple-500 hover:bg-purple-600 text-white py-2 rounded-lg">
          Confirm Deposit
        </Button>
